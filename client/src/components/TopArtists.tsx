...
export default function TopArtists({artists}: {artists: Record<string, number>}) {
  ...
  const [options, setOptions] = useState<ApexOptions>({
    ...
    yaxis: {
      title: {text: "Artist", style: {fontSize: "16px", fontWeight: 900, color: "#333"}},
      labels: {show: true, style: {fontSize: "13px", fontWeight: 700, colors: ["#333"]}}
    },
    title: {
      text: "Top Artists",
      align: "center",
